    ...
    <div class="header @@classList">
        <!-- navbar -->
        <nav class="navbar-classic navbar navbar-expand-lg <?= !$this->session->has_userdata(SESSION_KEY) ? 'pt-5 pb-3' : ''?>">
            ...
            <ul class="navbar-nav navbar-right-wrap ms-auto d-flex nav-top-wrap">
                ...
                <li class="dropdown ms-2">
                    <a class="rounded-circle" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="avatar avatar-md avatar-indicators avatar-online">
                            <img alt="avatar" src="https://ui-avatars.com/api/?name=<?= urlencode(current_user()->name) ?>&background=random" class="rounded-circle" />
                        </div>
                    </a>
                ...
                <?php else : ?>
                <li>
                    <a href="<?= base_url('login'); ?>" class="btn btn-outline-primary btn-sm rounded-pill px-4">Login</a>
                </li>
                <?php endif; ?>
            </ul>
        </nav>
