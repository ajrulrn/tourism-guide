...
<div id="db-wrapper">    
    ...
    <div id="page-content">
        ...
        <div class="container-fluid mt-n22 px-">
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-3">
                                    <div class="row d-flex align-items-center">
                                        <div class="col-12">
                                            <p class="m-0 fs-5 fw-bold"><?= $destination->title; ?></p>
                                            <p class="m-0 fs-6 fw-light text-secondary"><?= ucwords(strtolower(strtr($destination->city, ['KOTA' => '', 'KAB. ' => '']))); ?></p>
                                        </div>
