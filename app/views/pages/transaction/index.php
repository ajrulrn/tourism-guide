            ...
            <div class="row">
                <div class="col-12">
                    <div class="input-group mb-3" style="border-radius: 14px; box-shadow:3px 2px 40px 3px #ccc !important">
                        <input type="text" class="form-control border-0" placeholder="Cari transaksi, ex: IV#123" aria-label="Recipient's username" aria-describedby="button-addon2" style="border-radius: 14px 0 0 14px; box-shadow: none">
                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="mb-2 mb-lg-0">
                                <h3 class="mb-0 fw-bold text-primary">Transaksi</h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card p-3 borde border-primary">
                            <div class="row d-flex align-items-center">
                                ...
                                <!-- <div class="col-6 text-end">
                                    <p class="m-0 text-primary fs-6">Beri Ulasan</p>
                                </div> -->
                            </div>
                        </div>
                    </a>
